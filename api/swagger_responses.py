...
token_logout_responses = {**{status.HTTP_204_NO_CONTENT: openapi.Response('Токен удалён')}, **err_dict_401_unauthorized}
token_login_responses = {status.HTTP_200_OK: openapi.Response(
        'Токен получен', examples={'application/json': {'auth_token': 'b7f998457067d2ff1d0d78d31c36fa28e372ae7b'}}),
        status.HTTP_400_BAD_REQUEST: openapi.Response(
        'Невозможно войти с предоставленными учётными данными', examples={'application/json': {'non_field_errors': [
...
user_post_responses = {status.HTTP_201_CREATED: openapi.Response('Пользователь создан',
        ...
        UniqueTogetherValidator.missing_message
    ]}})}
...
delete_all_cart_responses = {**{status.HTTP_204_NO_CONTENT: openapi.Response('Успешная очистка корзины')}, **err_dict_401_unauthorized}
